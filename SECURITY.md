...
Chromium MV3 release и поддерживаемые Chromium MV3/Firefox MV3 исходники в
текущем `main`. Firefox пока не является публичным выпуском. Исторические
MV2/Firefox/store пакеты upstream не являются поддерживаемым продуктом этого
репозитория.
