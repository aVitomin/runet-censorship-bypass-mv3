...
> This is the historical upstream-facing README preserved for attribution and
> reference. Its installation links and instructions may not describe this
> Chromium Manifest V3 fork. For current information, use the repository
> [README](../../README.md) and the [user documentation](../user/).
