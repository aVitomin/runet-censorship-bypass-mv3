# Archived beta 1 release-candidate notes

> Historical engineering snapshot for the `v0.0.2.0-beta1` candidate. Test
> counts and pending items below reflect that snapshot; the GitHub release and
> current documentation are authoritative for users.
